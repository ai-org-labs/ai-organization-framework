...
const COMMAND_SPECS = [
  ...
  ["work-item-goal", "./commands/work-governance-records.js", "workItemGoalCommand"],
  ["actor-compose", "./commands/work-governance-records.js", "actorComposeCommand"],
  ["council-ready-output", "./commands/work-governance-records.js", "councilReadyOutputCommand"],
  ["go-no-go-visualization", "./commands/work-governance-records.js", "goNoGoVisualizationCommand"],
  ...
  ["external-runtime-resource-record", "./commands/external-runtime-resource-record.js", "externalRuntimeResourceRecordCommand"],
  ["external-resource-use-record", "./commands/external-resource-use-record.js", "externalResourceUseRecordCommand"],
  ...
  ["provider-adapter-pilot-record", "./commands/provider-adapter-pilot-record.js", "providerAdapterPilotRecordCommand"],
  ["provider-adapter-pilot-audit", "./commands/provider-adapter-pilot-audit.js", "providerAdapterPilotAuditCommand"],
  ["provider-operation-target-record", "./commands/provider-operation-target-record.js", "providerOperationTargetRecordCommand"],
  ["human-approval-record", "./commands/human-approval-record.js", "humanApprovalRecordCommand"],
  ["provider-execution-approval-record", "./commands/provider-execution-approval-record.js", "providerExecutionApprovalRecordCommand"],
  ["provider-execution-approval-audit", "./commands/provider-execution-approval-audit.js", "providerExecutionApprovalAuditCommand"],
  ["provider-execution-reproduction-record", "./commands/provider-execution-reproduction-record.js", "providerExecutionReproductionRecordCommand"],
  ["provider-execution-reproduction-audit", "./commands/provider-execution-reproduction-audit.js", "providerExecutionReproductionAuditCommand"],
  ["provider-rollback-proof-record", "./commands/provider-rollback-proof-record.js", "providerRollbackProofRecordCommand"],
  ["provider-rollback-proof-audit", "./commands/provider-rollback-proof-audit.js", "providerRollbackProofAuditCommand"],
  ["provider-outcome-evidence-record", "./commands/provider-outcome-evidence-record.js", "providerOutcomeEvidenceRecordCommand"],
  ["provider-outcome-evidence-audit", "./commands/provider-outcome-evidence-audit.js", "providerOutcomeEvidenceAuditCommand"],
  ["provider-learning-loop-record", "./commands/provider-learning-loop-record.js", "providerLearningLoopRecordCommand"],
  ...
  ["mission-control-projection-audit", "./commands/mission-control-projection-audit.js", "missionControlProjectionAuditCommand"],
