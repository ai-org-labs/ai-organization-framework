...
const INPUT_HINTS = {
  ...
  "provider-execution-approval-record": ["project", "pilot-ref", "adapter-ref", "work-item-id", "work-item-ref", "session-ref", "approval-decision", "approved-execution-mode", "execution-scope", "allowed-operation", "denied-operation", "side-effect-boundary", "redaction-boundary", "rollback-plan", "credential-boundary", "budget-boundary", "provenance-ref", "verification-ref", "stop-condition", "production-execution-status", "not-proven", "source-task-id", "source-parent-session-id", "write-artifact?"],
