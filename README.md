...
現在の stable release は `v7.1.0` である。
...
- current release definition: [docs/v7.1-release-definition.md](docs/v7.1-release-definition.md)
- current release checklist: [docs/v7.1-release-checklist.md](docs/v7.1-release-checklist.md)
- current release notes: [docs/v7.1.0-release-notes.md](docs/v7.1.0-release-notes.md)
