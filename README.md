...
現在の stable release は `v6.4.0` である。
...
- current release definition: [docs/v6.4-release-definition.md](docs/v6.4-release-definition.md)
- current release checklist: [docs/v6.4-release-checklist.md](docs/v6.4-release-checklist.md)
- current release notes: [docs/v6.4.0-release-notes.md](docs/v6.4.0-release-notes.md)
