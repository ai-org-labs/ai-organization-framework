...
現在の stable release は `v8.8.0` である。
...
- current release definition: [docs/v8.8-release-definition.md](docs/v8.8-release-definition.md)
- current release checklist: [docs/v8.8-release-checklist.md](docs/v8.8-release-checklist.md)
- current release notes: [docs/v8.8.0-release-notes.md](docs/v8.8.0-release-notes.md)
