...
現在の stable release は `v11.1.0` である。
...
- current release definition: [docs/v11.1-release-definition.md](docs/v11.1-release-definition.md)
- current release checklist: [docs/v11.1-release-checklist.md](docs/v11.1-release-checklist.md)
- current release notes: [docs/v11.1.0-release-notes.md](docs/v11.1.0-release-notes.md)
