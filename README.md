...
現在の stable release は `v10.0.0` である。
この release で、self-hosting runtime は次の状態に到達した。

- External Runtime Productization Decision を release-state governance surface として扱えること
...
- current release definition: [docs/v10.0-release-definition.md](docs/v10.0-release-definition.md)
- current release checklist: [docs/v10.0-release-checklist.md](docs/v10.0-release-checklist.md)
- current release notes: [docs/v10.0.0-release-notes.md](docs/v10.0.0-release-notes.md)
