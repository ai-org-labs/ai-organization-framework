...
現在の stable release は `v10.4.0` である。
...
- current release definition: [docs/v10.4-release-definition.md](docs/v10.4-release-definition.md)
- current release checklist: [docs/v10.4-release-checklist.md](docs/v10.4-release-checklist.md)
- current release notes: [docs/v10.4.0-release-notes.md](docs/v10.4.0-release-notes.md)
