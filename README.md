...
現在の stable release は `v6.5.0` である。
...
- QIF `v0.3.0` provider profile を採用し、QIF Discovery Layer / QIF Core / AOF Integration の層を記録できること
- QIF v0.3 Discovery Layer はまだ executable verifier replacement ではないと明示できること
...
- current release definition: [docs/v6.5-release-definition.md](docs/v6.5-release-definition.md)
- current release checklist: [docs/v6.5-release-checklist.md](docs/v6.5-release-checklist.md)
- current release notes: [docs/v6.5.0-release-notes.md](docs/v6.5.0-release-notes.md)
