...
現在の stable release は `v8.5.1` である。
...
- current release definition: [docs/v8.5-release-definition.md](docs/v8.5-release-definition.md)
- current release checklist: [docs/v8.5-release-checklist.md](docs/v8.5-release-checklist.md)
- current release notes: [docs/v8.5.1-release-notes.md](docs/v8.5.1-release-notes.md)
