...
現在の stable release は `v9.4.2` である。
...
- current release definition: [docs/v9.4-release-definition.md](docs/v9.4-release-definition.md)
- current release checklist: [docs/v9.4-release-checklist.md](docs/v9.4-release-checklist.md)
- current release notes: [docs/v9.4.2-release-notes.md](docs/v9.4.2-release-notes.md)
