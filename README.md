...
現在の stable release は `v8.1.0` である。
...
- `release-state-audit` が `8.1.0` 以降の release で `provider-adapter-audit` を release gate として実行できること
- v8.1 provider adapter governance は structural/runtime evidence であり、autonomous external provider execution、semantic truth、operator acceptance、credential safety、billing safety の証明ではないと明示できること
...
- current release definition: [docs/v8.1-release-definition.md](docs/v8.1-release-definition.md)
- current release checklist: [docs/v8.1-release-checklist.md](docs/v8.1-release-checklist.md)
- current release notes: [docs/v8.1.0-release-notes.md](docs/v8.1.0-release-notes.md)
