...
現在の stable release は `v8.0.0` である。
...
- `release-state-audit` が `8.0.0` 以降の release で `external-resource-audit` を release gate として実行できること
- v8.0 external resource governance は structural/runtime evidence であり、autonomous external provider execution、semantic truth、operator acceptance の証明ではないと明示できること
...
- current release definition: [docs/v8.0-release-definition.md](docs/v8.0-release-definition.md)
- current release checklist: [docs/v8.0-release-checklist.md](docs/v8.0-release-checklist.md)
- current release notes: [docs/v8.0.0-release-notes.md](docs/v8.0.0-release-notes.md)
