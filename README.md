...
現在の stable release は `v6.3.0` である。
...
- current release definition: [docs/v6.3-release-definition.md](docs/v6.3-release-definition.md)
- current release checklist: [docs/v6.3-release-checklist.md](docs/v6.3-release-checklist.md)
- current release notes: [docs/v6.3.0-release-notes.md](docs/v6.3.0-release-notes.md)
