...
現在の stable release は `v6.0.0` である。
...
- viewer は runtime-backed visibility surface であり、完成した Human Recognition UX ではないことを明示できること
...
- current release definition: [docs/v6.0-release-definition.md](docs/v6.0-release-definition.md)
- current release checklist: [docs/v6.0-release-checklist.md](docs/v6.0-release-checklist.md)
- current release notes: [docs/v6.0.0-release-notes.md](docs/v6.0.0-release-notes.md)
