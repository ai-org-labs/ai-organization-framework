...
現在の stable release は `v11.9.0` である。
...
- current release definition: [docs/v11.9-release-definition.md](docs/v11.9-release-definition.md)
- current release checklist: [docs/v11.9-release-checklist.md](docs/v11.9-release-checklist.md)
- current release notes: [docs/v11.9.0-release-notes.md](docs/v11.9.0-release-notes.md)
