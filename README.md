...
現在の stable release は `v10.5.0` である。
...
- current release definition: [docs/v10.5-release-definition.md](docs/v10.5-release-definition.md)
- current release checklist: [docs/v10.5-release-checklist.md](docs/v10.5-release-checklist.md)
- current release notes: [docs/v10.5.0-release-notes.md](docs/v10.5.0-release-notes.md)
