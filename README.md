...
現在の stable release は `v9.9.0` である。
この release で、self-hosting runtime は次の状態に到達した。

- External Runtime Production Readiness Review を release-state governance surface として扱えること
...
- current release definition: [docs/v9.9-release-definition.md](docs/v9.9-release-definition.md)
- current release checklist: [docs/v9.9-release-checklist.md](docs/v9.9-release-checklist.md)
- current release notes: [docs/v9.9.0-release-notes.md](docs/v9.9.0-release-notes.md)
