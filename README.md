...
現在の stable release は `v9.0.0` である。
...
- current release definition: [docs/v9.0-release-definition.md](docs/v9.0-release-definition.md)
- current release checklist: [docs/v9.0-release-checklist.md](docs/v9.0-release-checklist.md)
- current release notes: [docs/v9.0.0-release-notes.md](docs/v9.0.0-release-notes.md)
