...
現在の stable release は `v8.2.0` である。
...
- current release definition: [docs/v8.2-release-definition.md](docs/v8.2-release-definition.md)
- current release checklist: [docs/v8.2-release-checklist.md](docs/v8.2-release-checklist.md)
- current release notes: [docs/v8.2.0-release-notes.md](docs/v8.2.0-release-notes.md)
