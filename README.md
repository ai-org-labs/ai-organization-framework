...
現在の stable release は `v11.4.0` である。
...
- current release definition: [docs/v11.4-release-definition.md](docs/v11.4-release-definition.md)
- current release checklist: [docs/v11.4-release-checklist.md](docs/v11.4-release-checklist.md)
- current release notes: [docs/v11.4.0-release-notes.md](docs/v11.4.0-release-notes.md)
