...
現在の stable release は `v7.7.0` である。
...
- current release definition: [docs/v7.7-release-definition.md](docs/v7.7-release-definition.md)
- current release checklist: [docs/v7.7-release-checklist.md](docs/v7.7-release-checklist.md)
- current release notes: [docs/v7.7.0-release-notes.md](docs/v7.7.0-release-notes.md)
