...
```bash
git clone --branch v9.9.0 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v9.9.0
cd ~/.local/share/aof/v9.9.0
npm install
npm link
```
...
- current release definition: [v9.9-release-definition.md](./v9.9-release-definition.md)
