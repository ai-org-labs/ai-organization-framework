...
```bash
git clone --branch v8.5.1 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v8.5.1
cd ~/.local/share/aof/v8.5.1
npm install
npm link
```
...
- current release definition: [v8.5-release-definition.md](./v8.5-release-definition.md)
