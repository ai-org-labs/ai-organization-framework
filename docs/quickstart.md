...
```bash
git clone --branch v9.4.1 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v9.4.1
cd ~/.local/share/aof/v9.4.1
npm install
npm link
```
...
- current release definition: [v9.4-release-definition.md](./v9.4-release-definition.md)
