...
```bash
git clone --branch v9.8.0 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v9.8.0
cd ~/.local/share/aof/v9.8.0
npm install
npm link
```
...
- current release definition: [v9.8-release-definition.md](./v9.8-release-definition.md)
