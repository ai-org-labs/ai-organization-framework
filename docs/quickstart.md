...
```bash
git clone --branch v8.9.0 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v8.9.0
cd ~/.local/share/aof/v8.9.0
npm install
npm link
```
...
- current release definition: [v8.9-release-definition.md](./v8.9-release-definition.md)
