...
```bash
git clone --branch v6.3.0 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v6.3.0
cd ~/.local/share/aof/v6.3.0
npm install
npm link
```
...
- current release definition: [v6.3-release-definition.md](./v6.3-release-definition.md)
