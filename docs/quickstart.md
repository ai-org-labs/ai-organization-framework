...
```bash
git clone --branch v10.1.0 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v10.1.0
cd ~/.local/share/aof/v10.1.0
npm install
npm link
```
...
- current release definition: [v10.1-release-definition.md](./v10.1-release-definition.md)
