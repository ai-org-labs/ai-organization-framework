...
```bash
git clone --branch v8.7.0 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v8.7.0
cd ~/.local/share/aof/v8.7.0
npm install
npm link
```
...
- current release definition: [v8.7-release-definition.md](./v8.7-release-definition.md)
