...
- Archmap `v0.4.0`: `https://github.com/ai-org-labs/archmap/releases/tag/v0.4.0`
- archmap-icons `v0.1.2`: `https://github.com/ai-org-labs/archmap-icons/tree/v0.1.2`

Provider update note:

- Archmap `v0.4.0` makes plugin-first lifecycle support, Requirements / Traceability / Quality views, deterministic graph trace APIs, DSL-authored Runtime views, and improved rendering readability available as external capabilities.
...
mechanism details. v9.4 made the provider chain legible as a controlled
