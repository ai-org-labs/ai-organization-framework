...
- spec/runtime source:
  - `https://github.com/ai-org-labs/ai-organization-framework/tree/v3.0.0`
- operational install source:
  - `git clone --branch v3.0.0 https://github.com/ai-org-labs/ai-organization-framework.git`
...
git clone --branch v3.0.0 https://github.com/ai-org-labs/ai-organization-framework.git ~/.local/share/aof/v3.0.0
